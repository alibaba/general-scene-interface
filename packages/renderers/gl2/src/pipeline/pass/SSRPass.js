// https://github.com/pissang/claygl/blob/master/example/ssr4.html
// https://github.com/guidoschmidt/moge/blob/master/source/shaders/deferred/ssr/ssr.frag.glsl
// https://github.com/mattdesl/audiograph.xyz/blob/master/lib/shader/mesh.frag
// https://github.com/mattdesl/audiograph.xyz/blob/master/lib/SSRPass.js
// https://github.com/mattdesl/audiograph.xyz/blob/master/lib/shader/ssr.vert#L14
// https://github.com/mattdesl/audiograph.xyz/blob/master/lib/shader/ssr.frag
// https://github.com/mattdesl/audiograph.xyz/blob/master/lib/shader/glsl-ssr.glsl

import Pass from '../Pass';
import fs from './glsl/ssr_fs.glsl';
import vs from './glsl/ssr_vs.glsl';
...
export default class SSRPass extends Pass {
    constructor(conf, THREE) {
        ...
        this.uniforms = {
            ...
            projectToPixelMatrix: { value: new THREE.Matrix4() },
            cameraInverseProjectionMatrix: { value: new THREE.Matrix4() },

            constantPixelStride: { type: 'f', value: conf.constantPixelStride },
            pixelStrideZCutoff: { type: 'f', value: conf.pixelStrideZCutoff },
            maxRayDistance: { type: 'f', value: conf.maxRayDistance },
            screenEdgeFadeStart: { type: 'f', value: 0.9 },
            eyeFadeStart: { type: 'f', value: conf.eyeFadeStart },
            eyeFadeEnd: { type: 'f', value: conf.eyeFadeEnd },
            renderBufferSize: { type: 'v2', value: new THREE.Vector2() },
            cb_zThickness: { type: 'f', value: conf.cb_zThickness },

            strideMagnitude: { value: 1 },

            minGlossiness: { value: 0.2 },
    ...
    render(renderer) {
        ...
        T.multiply(S);
        // ? camera
        screenScale.multiply(T).multiply(this.renderCamera.projectionMatrix);
