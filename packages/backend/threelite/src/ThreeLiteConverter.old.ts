...
export type DefaultConverterConfig = typeof DefaultConfig
...
export class ThreeLiteConverter implements Converter {
	 ...
	 */
	private _wrapper: MeshDataType = specifyMesh({
	 ...
	 * @param gsiColor
	 */
	private convColor(threeColor: Color | undefined, gsiColor: ColorRGB | string): Color {
