...
import { MeshBasicMaterial, UniformsUtils, ShaderLib } from '@gs.i/three-lite-renderer'
...
export class PrgBasicMaterial extends MeshBasicMaterial {
	type = 'ShaderMaterial'
	...
	uniforms: { [name: string]: any } = UniformsUtils.clone(ShaderLib.basic.uniforms)
